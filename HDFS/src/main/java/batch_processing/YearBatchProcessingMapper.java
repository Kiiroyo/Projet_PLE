...
public class YearBatchProcessingMapper extends Mapper<Text, CapteurWritable, Text, DataStatistiques> {
    ...
    protected void map(Text key, CapteurWritable capteur, Mapper<Text, CapteurWritable, Text, DataStatistiques>.Context context) throws IOException, InterruptedException {
        ...
        context.write(new Text(capteur.getCapteurID() + "," + capteur.getYear()), stats);
    }
