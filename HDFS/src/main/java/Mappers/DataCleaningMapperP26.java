...
public class DataCleaningMapperP26 extends Mapper<LongWritable, Text, Text, CapteurWritable>{
		...
		public void map(LongWritable key, Text value, Context context ) throws IOException, InterruptedException {
			...
			context.write(new Text("P26"), new CapteurWritable("P26",date,data[5],0.0,in));
		}
}
