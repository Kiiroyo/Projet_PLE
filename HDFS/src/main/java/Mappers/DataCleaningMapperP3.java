...
public class DataCleaningMapperP3 extends Mapper<LongWritable, Text, Text, CapteurWritable> {
    @Override
    public void map(LongWritable key, Text value, Context context ) throws IOException, InterruptedException {
        ...
        context.write(new Text("P3"), new CapteurWritable("P3",date,data[5],Double.parseDouble(data[4]),in));
